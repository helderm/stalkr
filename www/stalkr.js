    ...
    function renderGraph(data){
        ...
        // force layout setup
        var width = window.innerWidth*0.9, height = window.innerHeight*0.8;
        ...
        patterns
            ...
            .attr("height", "512")
            .attr("width", "512")
            .attr("xlink:href", "https://i.stack.imgur.com/bFjYq.jpg?s=32&g=1");
    ...
    var res = { "results": [
        {
            "columns": ["path"],
                "data"   : [{
                    "graph": {
                        "nodes": [
                        {"id": "1", "labels": ["User"], "properties": {"name": "Peter", "score": 9}},
                        {"id": "2", "labels": ["User"], "properties": {"name": "Michael", "score": 6}},
                        {"id": "3", "labels": ["User"], "properties": {"name": "Jungus", "score": 1}},
                        {"id": "4", "labels": ["User"], "properties": {"name": "McD", "score": 3}},
                        {"id": "7", "labels": ["User"], "properties": {"name": "Stallman", "score": 2}},
                        {"id": "8", "labels": ["User"], "properties": {"name": "Unix", "score": 10}},
